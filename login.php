     ...
     <div class="card">
            ...
            <div class="form-group">
                <p>Contraseña:</p><input type="nombre" class="form-project" id="NombreLeccion" aria-describedby="name" placeholder="Contraseña">
                     ...
                     <a href="upload_step2.php" class="btn btn-project">Iniciar sesión</a>
                </div>      
            </form>
    </div>

    <div class="card"> 
    <p style="text-align: center;">¿No tienes una cuenta aún?</p><a href="register.php" style="color: #0f4c81; font-weight: 600; font-size: 14pt; text-align: center; display: block;">Registrate aquí.</a> 
    </div>
